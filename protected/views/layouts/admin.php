...
<head>
    ...
    <link rel="icon" href="<?php echo Yii::app()->request->baseUrl; ?>/favicon_admin.ico?1" type="image/x-icon"/>
	...
	<div id="mainmenu">
		<?php $this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Заказы', 'url'=>'/admin/order/index', 'active'=>strpos(Yii::app()->request->pathInfo, 'order')===false? false:true, 'visible'=>!Yii::app()->user->isGuest),
